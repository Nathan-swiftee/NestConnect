...
```mermaid
flowchart TD
    App["Nest Connect app shell"] --> Nav["Left rail (icons)"]
...
- A full CRM — Nest Connect owns conversations and light contact data; it integrates with a CRM rather than replacing one.
